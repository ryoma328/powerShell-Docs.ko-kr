# <a name="installing-powershell-core-on-macos"></a><span data-ttu-id="3208c-101">macOS에서 PowerShell Core 설치</span><span class="sxs-lookup"><span data-stu-id="3208c-101">Installing PowerShell Core on macOS</span></span>
