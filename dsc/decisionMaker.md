...
DSC의 중심은 [구성](configurations.md)입니다.
...
구성은 [데이터 기반](configData.md)이기도 해서 운영 팀이 개발자의 개입 없이 환경을 쉽게 식별하고 변경할 수 있도록 합니다.
...
온-프레미스 솔루션의 경우 DSC에는 컴퓨터 관리를 중앙에 집중하고 그 상태에 대해 보고하는 데 사용할 수 있는 [끌어오기 서버](pullServer.md)가 있습니다.
...
DSC는 Linux를 관리하는 데에도 사용할 수 있습니다. 자세한 내용은 [Linux용 DSC 시작](lnxGettingStarted.md)을 참조하세요.
